...
float auroraGlow(float t, vec2 shift, vec3 res, float nFreq, float nAmp, float scale, float oDecay, float bHeight, float bSpread) {
  ...
  float yBand = uv.y * 10.0 - bHeight * 10.0;
  return 0.3 * max(exp(bSpread * (1.0 - 1.1 * abs(noiseVal + yBand))), 0.0);
}
